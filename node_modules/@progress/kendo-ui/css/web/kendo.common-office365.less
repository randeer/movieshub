...
@badge-padding: @button-padding-y;
...
// FileManager
@filemanager-spacer: calc(@button-padding-y * 4);
...
@filemanager-toolbar-search-tool-spacing: 0;
...
@filemanager-listview-item-icon-size: calc(@icon-size * 1.5);
...
@filemanager-preview-container-padding: calc(@filemanager-spacer * 6) 0 @filemanager-spacer 0;

@filemanager-preview-file-spacing-x: 20px;
@filemanager-preview-file-spacing-y: 0;

@filemanager-preview-icon-size: calc(@icon-size * 3);
...
@filemanager-drag-hint-icon-spacing: @button-padding-x;
