...
.k-colorpicker .k-picker-wrap.ng-invalid.ng-dirty {
  color: #f31700;
  border-color: rgba(243, 23, 0, 0.5);
}
...
.k-combobox .k-dropdown-wrap.ng-invalid.ng-dirty {
  color: #f31700;
  border-color: rgba(243, 23, 0, 0.5);
}
.k-combobox .k-select {
...
.k-dropdown .k-dropdown-wrap.ng-invalid.ng-dirty,
.k-dropdowntree .k-dropdown-wrap.ng-invalid.ng-dirty {
  color: #f31700;
  border-color: rgba(243, 23, 0, 0.5);
}
.k-state-invalid > .k-dropdown-wrap,
...
.k-multiselect .k-multiselect-wrap.ng-invalid.ng-touched,
.k-dropdowntree .k-multiselect-wrap.ng-invalid.ng-touched,
.k-multiselect .k-multiselect-wrap.ng-invalid.ng-dirty,
.k-dropdowntree .k-multiselect-wrap.ng-invalid.ng-dirty {
  color: #f31700;
  border-color: rgba(243, 23, 0, 0.5);
}
