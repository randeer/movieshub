	...
	(function($, undefined) {
	    ...
	    var ListView = Component.extend({
	        ...
	        defaultOptions: {
	            ...
	            template: "<div class='k-item' title='#:name##:extension#'>" +
	                            "<div class='file-group-icon'><span class='k-icon k-i-#= !isDirectory ? kendo.getFileGroup(extension, true) : 'folder' #'></span></div>" +
	                            "<div class='file-name'>#:name##:extension#</div>" +
	                      "</div>",
	            editTemplate: "<div class='k-item'>" +
	                                "<div class='file-group-icon'><span class='k-icon k-i-#= !isDirectory ? kendo.getFileGroup(extension, true) : 'folder' #'></span></div>" +
	                                "<div class='file-edit-input'><input type='text' class='k-textbox' data-bind='value:name' name='name' required='required' /></div>" +
	                          "</div>",
	            dropFilter: ".k-item",
	            navigatable: true
	        },
