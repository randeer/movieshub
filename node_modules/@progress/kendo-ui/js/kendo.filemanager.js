...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function($, undefined) {
	    ...
	    var SINGLE_FILES_PREVIEW_TEMPLATE = '<div class="#=styles.fileInfo#">' +
	                                            '<div class="#=styles.filePreviewWrapper#">' +
	                                                '<span class="k-icon k-i-#= !selection[0].isDirectory ? kendo.getFileGroup(selection[0].extension, true) : "folder" #"></span>' +
	                                            '</div>' +
	    ...
	    var MULTIPLE_FILES_PREVIEW_TEMPLATE = '<div class="#=styles.fileInfo#">' +
	                                                '<div class="#=styles.filePreviewWrapper#">' +
	                                                    '<span class="k-icon k-i-file"></span>' +
	                                                '</div>' +
	                                                '<div class="#=styles.fileTitleWrapper#">' +
	                                                    '<span class="#=styles.fileTitle#">' +
	                                                        '#=selection.length# ' +
	                                                        '#=messages.items#' +
	                                                    '</span>' +
	                                                '</div>' +
